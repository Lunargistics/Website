    ...
    ReentrancyGuard
{
    ...
    event ElementListed(uint256 indexed tokenId, address indexed seller, uint256 price);

    event ElementSold(uint256 indexed tokenId, address indexed seller, address indexed buyer, uint256 price);

    event ElementUpdated(uint256 indexed tokenId, uint256 version, string newWidgetCode);

    event ElementRated(uint256 indexed tokenId, address indexed rater, uint256 rating);

    event ElementSubscribed(uint256 indexed tokenId, address indexed subscriber);
    ...
    function updateSpaceElement(
        ...
        require(
            !widgetCodeExists[_newWidgetCode] ||
