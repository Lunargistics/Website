      ...
      const response = await fetch(`${VENICE_API_URL}/chat/completions`, {
        ...
        body: JSON.stringify({
          ...
          messages: [
            {
              role: 'system',
              content: 'You are a space mission compliance expert. Analyze documents for regulatory compliance, safety risks, and completeness. Provide concise, actionable insights for space engineers.'
            },
            {
              role: 'user',
      ...
      const response = await fetch(`${VENICE_API_URL}/chat/completions`, {
        ...
        body: JSON.stringify({
          ...
          messages: [
            {
              role: 'system',
              content: 'You are a space mission readiness analyst. Evaluate document completeness and provide launch readiness assessment.'
            },
            {
              role: 'user',
        ...
        body: JSON.stringify({
          ...
          messages: [
            ...
            },
            {
              ...
              Documents: ${JSON.stringify(documents.map(d => ({
                id: d.id,
                type: d.type,
                title: d.title,
                date: d.date
