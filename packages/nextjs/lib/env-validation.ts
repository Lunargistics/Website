...
const envSchema = z.object({
  ...
  return data.NEXT_PUBLIC_PINATA_JWT || 
         (data.NEXT_PUBLIC_PINATA_API_KEY && data.NEXT_PUBLIC_PINATA_SECRET_KEY);
}, {
...
export function isIPFSConfigured(): boolean {
  ...
  return !!(env.NEXT_PUBLIC_PINATA_JWT || 
           (env.NEXT_PUBLIC_PINATA_API_KEY && env.NEXT_PUBLIC_PINATA_SECRET_KEY));
}
