...
async function analyzeDocument(data: any) {
  const { documentType, missionName } = data;
      ...
      messages: [
        {
          role: "system",
          content:
            "You are a space mission compliance expert. Analyze documents for regulatory compliance, safety risks, and completeness.",
        },
        {
          role: "user",
      ...
      messages: [
        {
          role: "system",
          content:
            "You are a compliance expert. Validate if document access grants are appropriate for space missions.",
        },
        {
          role: "user",
