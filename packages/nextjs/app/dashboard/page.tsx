...
const AsteroidAPI = dynamic(() => import('~~/components/AsteroidAPI').then(mod => mod.AsteroidDataFetcher), { ssr: false });
...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen flex bg-gray-50">
      {/* Sidebar */}
      <aside className={`${sidebarOpen ? 'w-64' : 'w-20'} bg-indigo-900 text-white transition-all duration-300 ease-in-out`}>
        <div className="p-4">
